...
{
  if(state == 1)
  {   if(light_L2 == HIGH && light_L1== HIGH && light_M == HIGH && light_R1 == HIGH && light_R2 == HIGH && stateForward < 1)
      {
        TurnRight(speed_L+40, 0);
        stateForward++;
        delay(200);
      }
      if(light_L2 == LOW && light_R2 == HIGH || (light_L2 == LOW && light_L1== HIGH && light_M == HIGH && light_R1 == HIGH && light_R2 == HIGH ))  //TurnRight For High
      {
        TurnRight(speed_L+40, 0);
        delay(200);
      }
      else if((light_L2 == HIGH && light_R2 == LOW  && light_M == LOW)|| (light_L2 == HIGH && light_R2 == LOW && light_M == HIGH)|| (light_L2 == HIGH && light_L1== HIGH && light_M == HIGH && light_R1 == HIGH && light_R2 == LOW )) //TurnLeft For High
      {
        TurnLeft(0, speed_R+70);
        delay(250);
      }
      else if(light_L1 == LOW && light_R1 == HIGH)  //TurnRight For Low
      {
        TurnRight(speed_L+40, speed_L-50);
      }
      else if((light_L1 == HIGH && light_R1 == LOW) || (light_L1 == HIGH && light_M == HIGH))  //TurnLeft For Low
      {
        TurnLeft(speed_L-50,speed_R+40);
        delay(150);
      }
      ...
      else if (light_M == HIGH || ( light_L2 == LOW && light_L1== LOW && light_M == LOW && light_R1 == LOW && light_R2 == LOW ))    //GO
      {
...
//****** M ******//*
  if(sensor_M > (595)) { light_M = HIGH; } else { light_M = LOW; }
