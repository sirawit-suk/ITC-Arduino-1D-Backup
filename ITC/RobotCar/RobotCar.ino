...
{
  if(state == 1)
  {   if(light_L2 == HIGH && light_L1 == HIGH && light_M == HIGH && light_R1 == HIGH && light_R2 == HIGH && stateForward < 2)
      {
        Forward(speed_L+80, speed_R+80);
        delay(30);
        stateForward++;
      }
      else if(((light_L1 == HIGH && light_L2 == HIGH && light_M == HIGH && light_R1 == LOW && light_R2 == LOW) || (light_L1 == HIGH && light_L2 == HIGH && light_M == HIGH && light_R1 == HIGH && light_R2 == LOW))&& stateLeft < 2)
      {
        TurnLeft(0, speed_R+55);
        stateLeft++;
        delay(700);
      }
      else if(light_L2 == LOW && light_R2 == HIGH)  //TurnRight For High
      {
        TurnRight(speed_L+40, 0);
      }
      else if((light_L2 == HIGH && light_R2 == LOW  && light_M == LOW)|| (light_L2 == HIGH && light_R2 == LOW && light_M == HIGH)) //TurnLeft For High
      {
        TurnLeft(0, speed_R+40);
       // delay(100);
      }
      else if(light_L1 == LOW && light_R1 == HIGH)  //TurnRight For Low
      {
        TurnRight(speed_L+40, 0);
      }
      else if((light_L1 == HIGH && light_R1 == LOW) || (light_L1 == HIGH && light_M == HIGH))  //TurnLeft For Low
      {
        TurnLeft(speed_L-60,speed_R+40);
        delay(10);
      }
      else if(light_R2 == HIGH && light_R1 == HIGH) //Force TurnRight
      {
         TurnRight(speed_L+60, speed_R-40);
      }
//    else if(light_L2 == LOW && light_L1 == HIGH && light_M == HIGH && light_R1 == HIGH && light_R2 == HIGH)
//    {
//       TurnLeft(speed_L-40, speed_R+60);
//    }
      else if (light_M == HIGH)    //GO
      {
  ...
  /*else if(state == 2){
      if(light_M == HIGH && light_R1 == HIGH && light_R2 == HIGH)
      {
         TurnRight(speed_L+60, speed_R-40);
         delay(650);
      }
      else if(light_L2 == HIGH && light_L1 == HIGH && light_M == HIGH)
      {
        TurnLeft(speed_L-40, speed_R+60);
      }
      else if(light_L2 == HIGH && light_L1 == HIGH && light_M == HIGH && light_R1 == HIGH && light_R2 == HIGH)
      {
        TurnLeft(speed_L-40, speed_R+60);
      }
      else
...
{
//****** L2 ******//*                //LIGHT                    //DARK
  if(sensor_L2 > (550)) { light_L2 = HIGH; } else { light_L2 = LOW; }
  
//****** L1 ******//*
  if(sensor_L1 > (300+450)/2.f) { light_L1 = HIGH; } else { light_L1 = LOW; }

//****** M ******//*
  if(sensor_M > (525)) { light_M = HIGH; } else { light_M = LOW; }

//****** R1 ******//*
  if(sensor_R1 > (300+500)/2.f) { light_R1 = HIGH; } else { light_R1 = LOW; }

//****** R2 ******//*
  if(sensor_R2 > (520)) { light_R2 = HIGH; } else { light_R2 = LOW; }
